...
export function CaseStudyCard({ caseStudy, variant = 'compact', index = 0 }: CaseStudyCardProps) {
  if (variant === 'featured') {
    return (
      <motion.article
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                <div className="flex items-center">
                  {/* Small purple square dot next to industry */}
              ...
              {/* Title */}
              <Link href={`/insights/case-studies/${caseStudy.slug}`} className="block group/title">
    ...
    >
      <Link href={`/insights/case-studies/${caseStudy.slug}`} className="flex flex-col flex-1 p-6">
        ...
        <span className={`text-[10px] font-bold uppercase tracking-[0.2em] mb-2.5 block ${
          ...
          {caseStudy.industry} · {caseStudy.client.replace('Confidential - ', '')}
        </span>
