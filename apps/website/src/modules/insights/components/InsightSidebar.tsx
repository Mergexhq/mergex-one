      ...
      <aside
        className={`hidden lg:flex flex-col shrink-0 overflow-hidden transition-all duration-500 ${
          isToc
            ...
            : 'w-[290px] sticky top-0 self-start h-[calc(100vh-0)] bg-[#080808] dark:bg-[#080808]'
        }`}
      >
        ...
        {isToc && meta && (
          <div className="relative z-10 px-5 py-3.5 border-b border-white/8 flex items-center gap-5">
            <div>
              <p className="text-[8px] font-bold uppercase tracking-[0.18em] text-white/20 mb-0.5">Reading Time</p>
              <p className="text-[11px] text-white/50">{meta.readTime}</p>
            </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-[11px] text-white/25 mt-0.5 leading-tight">
                        {cat === 'All' ? 'All categories' : `${cat} articles`}
                      </p>
                    </div>
                  </Link>
                );
